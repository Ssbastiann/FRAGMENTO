...
$sql = "SELECT nombre, imagen, comentario, calificacion FROM comentarios ORDER BY fecha DESC";
$comentarios = $objetoSQL->consultar($sql);
?>
...
<body>
    ...
    <section class="opinions">
        <h2>OPINIONES</h2>
        <a href="opinions.php">Deja tu opinión</a>
        <div class="caja-contenedor" id="opinions">
            <?php foreach ($comentarios as $comentario) { ?>
            <div class="caja">
                <i class="fa fa-comments-o" aria-hidden="true"></i>
                <div class="user">
                    <img src="img/usuarios/<?php echo $comentario['imagen']; ?>"
                        alt="Imagen de <?php echo $comentario['nombre']; ?>">
                    <h3>
